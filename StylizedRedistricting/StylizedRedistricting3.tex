...
\title{Stylized Redistricting Game, Part 3}
...
We will work with a stylized polity map, shown on page 
  ...
  Further, if you have been assigned a polity controlled by the Democratic party, your plan should maximize the benefits (number of likely seats) for the Democratic party. Conversely,  if you have been assigned a polity controlled by the Republican party, your plan should maximize the benefits (number of likely seats) for the Republican party. In either case, you need to produce a ``majority minority'' district, one having at least five blocks with {\textit{\textbf{italic bold face type}}} (of the eight blocks in a district).
